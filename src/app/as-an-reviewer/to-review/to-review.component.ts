...
export class ToReviewComponent implements OnInit {
  ...
  ItemSetList(){
    ...
    var headers = new Headers();
    headers.append('Authorization', 'Bearer ' + this.cookieService.get('_PTBA'));
    this.http.get(credentials.host +"/review_menu/" + this.cookieService.get('_PAOID') +'/' + 'toreview',{headers:headers})
    .map(res => res.json())
    .catch((e: any) =>{
      return Observable.throw(e)
    } )
  ...
  getItemsetDet(id,sectionid){
    if(this.authService.canActivate()){
      ...
      var headers = new Headers();
      headers.append('Authorization', 'Bearer ' + this.cookieService.get('_PTBA'));
      this.http.get(credentials.host + "/item_details/" +this.cookieService.get('_PAOID') +"/"+ id + "/all_sections/" + 6,{headers:headers})
      .map(res => res.json())
      .catch((e: any) =>{
        return Observable.throw(e)
      } )
...
editItemList(sectionid,editableItem,editFlag){
  if(editFlag){
    ...
    localStorage.setItem('item_count', '0');
      ...
      localStorage.setItem("_tmpURL", '/as-a-reviewer/to-review');
    }
}
              ...
              data => {
                ...
                if(data.success == true){
                  ...
                  if(keyVal == 3){
                    ...
                    if(this.choosenItemSetId != undefined && this.choosenItemSetSection != undefined){
                      this.getItemsetDet(this.choosenItemSetId,this.choosenItemSetSection);
                    }
