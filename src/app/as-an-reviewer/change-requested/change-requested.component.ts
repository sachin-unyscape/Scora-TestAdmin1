...
@Component({
  selector: 'app-change-requested',
  templateUrl: './change-requested.component.html',
  styleUrls: ['./change-requested.component.scss'],
      animations: [
    trigger('dialog1', [
      transition('void => *', [
...
export class ChangeRequestedComponent implements OnInit {
  ...
  ItemSetList(){
    ...
    var headers = new Headers();
    headers.append('Authorization', 'Bearer ' + this.cookieService.get('_PTBA'));
    this.http.get(credentials.host +"/review_menu/" + this.cookieService.get('_PAOID') +'/' + 'changerequested',{headers:headers})
    .map(res => res.json())
    .catch((e: any) =>{
      return Observable.throw(e)
    } )
  ...
  getItemsetDet(id,sectionid){
    if(this.authService.canActivate()){
      ...
      var headers = new Headers();
      headers.append('Authorization', 'Bearer ' + this.cookieService.get('_PTBA'));
      this.http.get(credentials.host + "/item_details/" +this.cookieService.get('_PAOID') +"/"+ id + "/all_sections/" + 7,{headers:headers})
      .map(res => res.json())
      .catch((e: any) =>{
        return Observable.throw(e)
      } )
  ...
  saveStatusComments(val, keyVal){
    ...
    if(val == 1){
      ...
      //  Item Level
        ...
        if(val == 1){
          body.append('action', this.currentItemStatus);
          body.append('note', null);
        }else{
          body.append('action', null);
          body.append('note', this.curItemLevelComment);
              ...
              data => {
                ...
                if(data.success == true){
                  ...
                  if(keyVal == 3){
                    ...
                    this.eachSectionItems.section_items[this.showItem].attributes.current_item_status = this.currentItemStatus;
                    this.currentItemStatus = "";
                  }
