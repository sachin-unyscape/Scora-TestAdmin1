...
export class ManageUsersComponent implements OnInit {
  ...
  constructor(private http:Http,private router: Router,private _compiler: Compiler,public route:ActivatedRoute,private cookieService: CookieService,private authService :AuthServiceService,private modalService: BsModalService,private _notifications: NotificationsService,public GetItemService:GetItemService) {
  ...
  addMultipleUser(){
    ...
    for(var i=0;i<this.addMultipleUsers.users.length;i++){
      ...
      // else if(this.addMultipleUsers.users[i].first_name!="" || this.addMultipleUsers.users[i].last_name!="" || this.addMultipleUsers.users[i].email!=""  || this.addMultipleUsers.users[i].roles.length !=0){
      //   if(this.addMultipleUsers.users[i].first_name == '' || this.addMultipleUsers.users[i].first_name.indexOf(" ") >=0 ){
      //     this.fnameerr = true;
      //     break;
      //   }
      //   else if(this.addMultipleUsers.users[i].last_name == '' || this.addMultipleUsers.users[i].last_name.indexOf(" ") >=0 ){
      //     this.lnameerr = true;
      //     break;
      //   }
      //   else if(this.addMultipleUsers.users[i].email == '' || this.addMultipleUsers.users[i].email.indexOf(" ") >=0 ){
      //     this.emailerr = true;
      //     break;
      //   }
      //   else if(this.addMultipleUsers.users[i].roles.length == 0 ){
      //     this.roleserr = true;
      //     break;
      //   }
      // }
  ...
  addNewField(obj) {
    ...
    //for the custom field name validation
    if(obj === '')
    {
      this.customFieldValidate = true;
    }
    ...
    if(this.authService.canActivate()){
      ...
      if (this.newFieldType != '' && this.newFieldLabel != '') {
        this.showload = true;
