...
*/
  ...
  public measure_dataList = [];
  public usages_dataList = [];
  public numerical_dataList = [];
  public status_dataList = [];
    ...
    if (this.authService.canActivate()) {
      ...
      this.http.get(credentials.host + "/get_metadatas/" + this.cookieService.get('_PAOID'), { headers: headers })
        ...
        data => {    
          ...
          this.languageList = data.languages_data;
          this.measure_dataList = data.measure_data.measure_name;
          console.log(this.measure_dataList);
          this.usages_dataList = data.usages_data;
          console.log(this.usages_dataList);
          this.numerical_dataList = data.numerical_data;
          console.log(this.numerical_dataList);
          this.status_dataList = data.status_data;
          ...
          this.subTopLabelName = data.parameters;
